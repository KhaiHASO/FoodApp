...
import com.example.fooddr.Network.VolleyRegister.Contants;
import com.example.fooddr.Network.VolleyRegister.VolleySingleton;
...
public class SignUpActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.imageButtonRegistor).setOnClickListener(new View.OnClickListener() {
            @Override
